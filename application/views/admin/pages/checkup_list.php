            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($data as $item) { ?>
                        <tr>
                            <th scope="row"><?= $no++; ?></th>
                            <td><?= $item->tanggal_checkup; ?></td>
                            <td><?= $item->email_user; ?></td>
                            <td><?= $item->kode_checkup; ?></td>
                            <td>
                                <a href="<?= site_url('checkup/predict_result/') . $item->kode_checkup ?>" target="_blank"
                                    class=" btn btn-info btn-circle" id="btn-edit">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="#" class="btn btn-danger btn-circle" id="btn-hapus"
                                    data-id="<?= $item->kode_checkup ?>">
